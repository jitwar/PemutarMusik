...
<body >
  <div id="container">
    ...
    <div class="form-group">
      <div class="input-group">
        ...
        <form method="POST" action="listmusik.php">
          <input type="submit" name="tombol">
          <input type="text" name="search_text" id="keyword" placeholder=" Pencarian"c
  ...
  <nav class="navbar navbar-expand-sm bg-dark navbar-dark fixed-top">
    <div id="mySidenav" class="sidenav">
      ...
      <a href="../user/berandauser.php"><i class="fa fa-fw fa-home"></i> Home</a>
    ...
    <a class="navbar-brand" href="../user/berandauser.php" style="margin-left: 4%">
  ...
  <div class="container-fluid" style="margin-top:80px" id="containert">
    ...
    $sql = mysqli_query($conn, "select * from song order by id desc") or die (mysqli_error());
